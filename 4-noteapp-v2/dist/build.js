...
/***/ function(module, exports) {
	...
	var NOTE_LOADLIST = exports.NOTE_LOADLIST = 'NOTE_LOADLIST';
	var NOTE_DELETEONE = exports.NOTE_DELETEONE = 'NOTE_DELETEONE';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var STORAGE = new _html2.default();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _note = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getters = {
		...
		filter: function filter(state) {
			return undefined.state.notes.filter(function (r) {
				return r.id !== "";
			});
		}
	};
	...
	//mutations
	var mutations = (_mutations = {}, _defineProperty(_mutations, types.NOTE_LOADLIST, function (state) {
		state.notes = _api.Storage.findAll().reverse();
	}), _defineProperty(_mutations, types.NOTE_DELETEONE, function (state, _ref) {
		var id = _ref.id;

		_api.Storage.deleteOne(id);
		state.notes = _api.Storage.findAll().reverse();
	}), _mutations);
	...
	var actions = {
		//load list
		deleteOne: function deleteOne(_ref2, _ref3) {
